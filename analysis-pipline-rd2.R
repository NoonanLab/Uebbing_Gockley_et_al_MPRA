...
plot(p12d,ylab="Relative amount",xlab=expression(paste(log[2]," pDNA")),main="MPRA 1 rep 12",xlim=c(-5,3))
abline(v=p12d$x[which.max(p12d$y)],lwd=2)
plot(c12d,ylab="Relative amount",xlab=expression(paste(log[2]," cDNA")),main="MPRA 1 rep 12",xlim=c(-5,3))
abline(v=c12d$x[which.max(c12d$y)],lwd=2)
plot(a12d,ylab="Relative amount",xlab=expression(paste(log[2]," activity")),main="MPRA 1 rep 12",xlim=c(-5,3))
abline(v=a12d$x[which.max(a12d$y)],lwd=2)
plot(p13d,ylab="Relative amount",xlab=expression(paste(log[2]," pDNA")),main="MPRA 1 rep 13",xlim=c(-5,3))
abline(v=p13d$x[which.max(p13d$y)],lwd=2)
plot(c13d,ylab="Relative amount",xlab=expression(paste(log[2]," cDNA")),main="MPRA 1 rep 13",xlim=c(-5,3))
abline(v=c13d$x[which.max(c13d$y)],lwd=2)
plot(a13d,ylab="Relative amount",xlab=expression(paste(log[2]," activity")),main="MPRA 1 rep 13",xlim=c(-5,3))
abline(v=a13d$x[which.max(a13d$y)],lwd=2)
plot(p22d,ylab="Relative amount",xlab=expression(paste(log[2]," pDNA")),main="MPRA 1 rep 22",xlim=c(-5,3))
abline(v=p22d$x[which.max(p22d$y)],lwd=2)
plot(c22d,ylab="Relative amount",xlab=expression(paste(log[2]," cDNA")),main="MPRA 1 rep 22",xlim=c(-5,3))
abline(v=c22d$x[which.max(c22d$y)],lwd=2)
plot(a22d,ylab="Relative amount",xlab=expression(paste(log[2]," activity")),main="MPRA 1 rep 22",xlim=c(-5,3))
abline(v=a22d$x[which.max(a22d$y)],lwd=2)
plot(p23d,ylab="Relative amount",xlab=expression(paste(log[2]," pDNA")),main="MPRA 1 rep 23",xlim=c(-5,3))
abline(v=p23d$x[which.max(p23d$y)],lwd=2)
plot(c23d,ylab="Relative amount",xlab=expression(paste(log[2]," cDNA")),main="MPRA 1 rep 23",xlim=c(-5,3))
abline(v=c23d$x[which.max(c23d$y)],lwd=2)
plot(a23d,ylab="Relative amount",xlab=expression(paste(log[2]," activity")),main="MPRA 1 rep 23",xlim=c(-5,3))
...
plot(p1d,ylab="Relative amount",xlab=expression(paste(log[2]," pDNA")),main="MPRA 2 rep 1",xlim=c(-5,3))
abline(v=p1d$x[which.max(p1d$y)],lwd=2)
plot(c1d,ylab="Relative amount",xlab=expression(paste(log[2]," cDNA")),main="MPRA 2 rep 1",xlim=c(-5,3))
abline(v=c1d$x[which.max(c1d$y)],lwd=2)
plot(a1d,ylab="Relative amount",xlab=expression(paste(log[2]," activity")),main="MPRA 2 rep 1",xlim=c(-5,3))
abline(v=a1d$x[which.max(a1d$y)],lwd=2)
plot(p2d,ylab="Relative amount",xlab=expression(paste(log[2]," pDNA")),main="MPRA 2 rep 2",xlim=c(-5,3))
abline(v=p2d$x[which.max(p2d$y)],lwd=2)
plot(c2d,ylab="Relative amount",xlab=expression(paste(log[2]," cDNA")),main="MPRA 2 rep 2",xlim=c(-5,3))
abline(v=c2d$x[which.max(c2d$y)],lwd=2)
plot(a2d,ylab="Relative amount",xlab=expression(paste(log[2]," activity")),main="MPRA 2 rep 2",xlim=c(-5,3))
